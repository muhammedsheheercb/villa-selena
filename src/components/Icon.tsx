...
export const Icons = {
  twitter: (props: IconProps) => (
    ...
    >
      <path
        d="M34.178 13.394c.02.281.02.563.02.846 0 8.651-6.586 18.618-18.618 18.618v-.004a18.543 18.543 0 0 1-10.037-2.936 13.145 13.145 0 0 0 9.686-2.713 6.554 6.554 0 0 1-6.118-4.545 6.538 6.538 0 0 0 2.955-.112 6.547 6.547 0 0 1-5.25-6.413v-.082a6.498 6.498 0 0 0 2.972.819 6.555 6.555 0 0 1-2.027-8.745 18.59 18.59 0 0 0 13.49 6.838 6.553 6.553 0 0 1 11.155-5.972 13.115 13.115 0 0 0 4.16-1.59 6.57 6.57 0 0 1-2.88 3.62 13.065 13.065 0 0 0 3.769-1.034 13.32 13.32 0 0 1-3.277 3.385z"
        fill="currentColor"
      />
    </svg>
  ),
  youtube: (props: IconProps) => (
    ...
    >
      <path
        d="M32.856 13.475c-.347-1.301-1.37-2.326-2.67-2.673C28.03 10.177 20.668 10.177 20.668 10.177s-7.362 0-9.518.625c-1.3.347-2.323 1.372-2.67 2.673-.625 2.156-.625 6.653-.625 6.653s0 4.497.625 6.653c.347 1.301 1.37 2.326 2.67 2.673 2.156.625 9.518.625 9.518.625s7.362 0 9.518-.625c1.3-.347 2.323-1.372 2.67-2.673.625-2.156.625-6.653.625-6.653s0-4.497-.625-6.653zm-14.158 10.75v-8.194l6.364 4.097-6.364 4.097z"
        fill="currentColor"
      />
    </svg>
  ),
  tiktok: (props: IconProps) => (
    ...
    >
      <path
        d="M28.753 13.267a6.39 6.39 0 0 1-1.884-4.535V7.873h-4.54v17.454c0 2.02-1.64 3.66-3.66 3.66a3.663 3.663 0 0 1-3.66-3.66c0-2.02 1.64-3.66 3.66-3.66.38 0 .747.062 1.093.175v-4.62a8.193 8.193 0 0 0-1.093-.073c-4.54 0-8.22 3.68-8.22 8.22 0 4.54 3.68 8.22 8.22 8.22 4.54 0 8.22-3.68 8.22-8.22v-8.893a10.907 10.907 0 0 0 6.424 2.08v-4.56a6.407 6.407 0 0 1-4.56-1.729z"
        fill="currentColor"
      />
    </svg>
  ),
